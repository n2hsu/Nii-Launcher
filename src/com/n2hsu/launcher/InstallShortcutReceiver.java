...
public class InstallShortcutReceiver extends BroadcastReceiver {
	...
	public static final String SHORTCUT_MIMETYPE = "com.n2hsu.launcher/shortcut";

	private static Object sLock = new Object();

	private static void addToStringSet(SharedPreferences sharedPrefs, SharedPreferences.Editor editor,
	...
	private static void addToInstallQueue(SharedPreferences sharedPrefs, PendingInstallShortcutInfo info) {
		synchronized (sLock) {
			try {
				JSONStringer json = new JSONStringer().object().key(DATA_INTENT_KEY)
						.value(info.data.toUri(0)).key(LAUNCH_INTENT_KEY).value(info.launchIntent.toUri(0))
	...
	public static void removeFromInstallQueue(SharedPreferences sharedPrefs, ArrayList<String> packageNames) {
		synchronized (sLock) {
			...
			if (strings != null) {
				...
				sharedPrefs.edit().putStringSet(APPS_PENDING_INSTALL, new HashSet<String>(newStrings))
						.commit();
			}
		}
	}
	...
	public void onReceive(Context context, Intent data) {
		...
		Intent.ShortcutIconResource iconResource = data
