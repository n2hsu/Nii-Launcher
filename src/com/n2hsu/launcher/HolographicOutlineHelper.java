...
public class HolographicOutlineHelper {
	...
	/**
	 * Returns the interpolated holographic highlight alpha for the effect we
	 * want when scrolling pages.
	 */
	...
	/**
	 * Returns the interpolated view alpha for the effect we want when scrolling
	 * pages.
	 */
	...
	/**
	 * Applies a more expensive and accurate outline to whatever is currently
	 * drawn in a specified bitmap.
	 */
	...
	void applyExpensiveOutlineWithBlur(Bitmap srcDst, Canvas srcDstCanvas, int color, int outlineColor,
			boolean clipAlpha, int thickness) {

		// We start by removing most of the alpha channel so as to ignore
		// shadows, and
		// other types of partial transparency when defining the shape of the
		// object
		if (clipAlpha) {
