...
final class Utilities {
	...
	static Bitmap createIconBitmap(Bitmap icon, Context context) {
		...
		if (sourceWidth > textureWidth && sourceHeight > textureHeight) {
			...
			return Bitmap.createBitmap(icon, (sourceWidth - textureWidth) / 2,
					(sourceHeight - textureHeight) / 2, textureWidth, textureHeight);
	 ...
	 *            Whether or not to account for the scroll of the descendant:
	 *            sometimes this is relevant as in a child's coordinates within
	 *            the descendant.
