 ...
 * which span multiple cells into a grid-like layout. Also supports dimming to
 * give a preview of its contents.
 */
public class PagedViewCellLayoutChildren extends ViewGroup {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		for (int i = 0; i < count; i++) {
			...
			lp.setup(getContext(), mCellWidth, mCellHeight, mWidthGap, mHeightGap, getPaddingLeft(),
					getPaddingTop());
