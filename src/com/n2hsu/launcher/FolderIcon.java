...
import com.n2hsu.launcher.FolderInfo.FolderListener;
...
public class FolderIcon extends LinearLayout implements FolderListener {
	...
	// Flag as to whether or not to draw an outer ring. Currently none is
	// designed.
	...
	static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group, FolderInfo folderInfo,
			IconCache iconCache) {
	...
	public void performCreateAnimation(final ShortcutInfo destInfo, final View destView,
			final ShortcutInfo srcInfo, final DragView srcView, Rect dstRect, float scaleRelativeToDragLayer,
