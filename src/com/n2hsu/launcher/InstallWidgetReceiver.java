...
/**
 * We will likely flesh this out later, to handle allow external apps to place
 * widgets, but for now, we just want to expose the action around for checking
 * elsewhere.
 */
public class InstallWidgetReceiver {
	public static final String ACTION_INSTALL_WIDGET = "com.n2hsu.launcher.action.INSTALL_WIDGET";
	public static final String ACTION_SUPPORTS_CLIPDATA_MIMETYPE = "com.n2hsu.launcher.action.SUPPORTS_CLIPDATA_MIMETYPE";

	// Currently not exposed. Put into Intent when we want to make it public.
	// TEMP: Should we call this "EXTRA_APPWIDGET_PROVIDER"?
	public static final String EXTRA_APPWIDGET_COMPONENT = "com.n2hsu.launcher.extra.widget.COMPONENT";
	public static final String EXTRA_APPWIDGET_CONFIGURATION_DATA_MIME_TYPE = "com.n2hsu.launcher.extra.widget.CONFIGURATION_DATA_MIME_TYPE";
	public static final String EXTRA_APPWIDGET_CONFIGURATION_DATA = "com.n2hsu.launcher.extra.widget.CONFIGURATION_DATA";

	/**
	 * A simple data class that contains per-item information that the adapter
	 * below can reference.
	 */
	...
	/**
	 * The ListAdapter which presents all the valid widgets that can be created
	 * for a given drop.
	 */
