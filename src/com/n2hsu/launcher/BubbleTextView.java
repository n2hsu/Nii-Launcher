...
public class BubbleTextView extends TextView {
		...
		if (isPressed()) {
			...
			if (isFocused()) {
				if (getLayout() == null) {
					...
					mPressedOrFocusedBackground = createGlowingOutline(mTempCanvas, mFocusedGlowColor,
	...
	private void drawWithPadding(Canvas destCanvas, int padding) {
		...
		clipRect.bottom = getExtendedPaddingTop() - (int) BubbleTextView.PADDING_V
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (mPressedOrFocusedBackground == null) {
				mPressedOrFocusedBackground = createGlowingOutline(mTempCanvas, mPressedGlowColor,
