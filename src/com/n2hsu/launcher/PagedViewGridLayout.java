...
/**
 * The grid based layout used strictly for the widget/wallpaper tab of the
 * AppsCustomize pane
 */
public class PagedViewGridLayout extends GridLayout implements Page {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		// PagedView currently has issues with different-sized pages since it
		// calculates the
		// offset of each page to scroll to before it updates the actual size of
		// each page
		// (which can change depending on the content if the contents aren't a
		// fixed size).
