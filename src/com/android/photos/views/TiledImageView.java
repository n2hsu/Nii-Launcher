...
/**
 * Shows an image using {@link TiledImageRenderer} using either
 * {@link GLSurfaceView} or {@link BlockingGLTextureView}.
 */
public class TiledImageView extends FrameLayout {
	...
	private void updateScaleIfNecessaryLocked(ImageRendererWrapper renderer) {
		...
		renderer.scale = Math.min((float) getWidth() / (float) renderer.source.getImageWidth(),
